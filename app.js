...
// Amvera прокидывает трафик на порт, указанный в amvera.yml -> run.containerPort.
// Значение по умолчанию (3000) здесь совпадает с containerPort в amvera.yml —
// даже если переменная окружения PORT почему-то не будет передана платформой, порты не разъедутся.
